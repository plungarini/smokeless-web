...
export const circleIconButtonClass = `${iconButtonClass} h-11 w-11 text-[1.9rem] leading-none`;

export const deleteButtonClass = `${iconButtonClass} h-10 w-10 text-[1.75rem] leading-none`;

export const sectionLabelClass = 'text-detail uppercase tracking-[0.24em] text-text-dim';

export const segmentedButtonBaseClass =
	'rounded-full border-0 bg-transparent px-2 py-[0.9rem] text-[12px] font-semibold tracking-[0.02em] text-text-dim';
